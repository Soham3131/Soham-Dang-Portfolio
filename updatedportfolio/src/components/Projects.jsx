...
//     ],
//     tech: ["React", "React Three Fiber", "Node.js", "Express", "MongoDB", "Tailwind CSS"],
...
// //   return (
// //     <div className="flex flex-col md:flex-row h-full w-full bg-[#111]">
// //       {/* LEFT SIDE: Video/Image Media */}
// //       <div className="w-full md:w-1/2 h-64 md:h-full relative bg-black border-r border-white/10">
...
// //       <div className="w-full md:w-1/2 h-full p-6 md:p-8 flex flex-col gap-5 overflow-y-auto bg-zinc-900/50 text-left">
// //         {/* Header */}
// //         <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-emerald-400">
// //           {/* <span className="bg-emerald-500/10 border border-emerald-500/20 px-2 py-1 rounded">
// //             {project.year}
// //           </span> */}
...
// //       {/* CHANGED: gap-32 to gap-0 to reduce space between projects */}
...
//   // Handle Play: Expands component, plays video, hides text
//   const handlePlay = () => {
//     setIsPlaying(true);
//     if (videoRef.current) {
...
//   // Handle Close: Shrinks component, pauses video, shows text
//   const handleClose = (e) => {
//     e.stopPropagation(); // Prevent triggering play again if bubbling
//     setIsPlaying(false);
//     if (videoRef.current) {
...
//           isPlaying 
//             ? "absolute inset-0 z-50 w-full h-full" // Takes full space when playing
//             : "w-full md:w-1/2 h-64 md:h-full border-r border-white/10" // Normal split view
//         }`}
//       >
//         <div className="h-full w-full relative bg-black group">
//           {activeMedia.type === "image" ? (
//             <img
//               src={activeMedia.src}
//               alt={activeMedia.label}
...
//                 src={activeMedia.src}
//                 poster={activeMedia.poster}
//                 // NO CONTROLS attribute here, so user cannot pause via native UI
//                 className="h-full w-full object-cover"
//                 playsInline
//                 onEnded={() => setIsPlaying(false)} // Auto-close when video finishes? Remove if you want it to loop/stop at end.
//               />

//               {/* Play Overlay - Only visible if NOT playing */}
//               {!isPlaying && (
//                 <div 
//                   onClick={handlePlay}
//                   className="absolute inset-0 flex items-center justify-center bg-black/20 hover:bg-black/10 cursor-pointer transition-all"
//                 >
//                   <div className="bg-white/10 backdrop-blur-sm p-4 rounded-full border border-white/20 shadow-xl group-hover:border-emerald-500/50 transition-colors">
//                      <PlayIcon />
//                   </div>
//                 </div>
//               )}

//               {/* Close Button - Only visible if IS playing */}
//               {isPlaying && (
//                 <button
//                   onClick={handleClose}
//                   className="absolute top-6 right-6 z-50 bg-black/50 hover:bg-red-600/80 text-white p-2 rounded-full backdrop-blur-md border border-white/10 transition-all"
//                 >
//                   <CloseIcon />
//                 </button>
//               )}
...
//         {/* Media Toggles - Hide these when video is full screen */}
//         {!isPlaying && project.media.length > 1 && (
...
//       {/* RIGHT SIDE: Text Info */}
//       {/* Hidden opacity/pointer-events when isPlaying is true */}
//       <div 
...
//           isPlaying ? "opacity-0 pointer-events-none hidden" : "opacity-100"
//         }`}
//       >
//         {/* Header */}
//         <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-emerald-400">

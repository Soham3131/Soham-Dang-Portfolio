  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <h2>Hire Soham Dang - Full Stack MERN Developer</h2>
        <p>
          Contact Soham Dang for freelance web development projects, full-time hiring, or 3D web consulting. 
          Based in <strong>Rohtak, Haryana</strong> and available for remote work globally.
        </p>
        ...
        <p><strong>Contact Email:</strong> Sohamdang0@gmail.com</p>
        <p><strong>Connect:</strong> Reach out on LinkedIn or Instagram (@soham_.31) for collaborations.</p>
      </div>
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8 text-center md:text-left">
              ...
              <div className="relative group shrink-0">
                ...
                <div className="relative overflow-hidden rounded-full w-28 h-28 md:w-32 md:h-32 border border-white/8 bg-slate-900">
                  <img
                    ...
                    alt="Soham Dang - Hire Full Stack Developer Rohtak"
                    className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105"
                    draggable={false}
                  />
                </div>
              ...
              <div>
                ...
                {/* Socials: Center on mobile, left on desktop */}
                <div className="mt-4 flex justify-center md:justify-start gap-3">
                  <SocialLink href="https://github.com/Soham3131" label="GitHub Profile - Soham Dang" icon={<Github className="h-5 w-5" />} />
                  <SocialLink href="https://www.linkedin.com/in/soham-dang-9ba897215/" label="LinkedIn Profile - Soham Dang" icon={<Linkedin className="h-5 w-5" />} />
                  <SocialLink href="https://www.instagram.com/soham_.31/#" label="Instagram Profile - Soham Dang" icon={<Instagram className="h-5 w-5" />} />
                </div>
              </div>
            </div>
          </motion.div>
